...
namespace Lucene.Net.Support
{
    ...
    {
        public static void Add(IDictionary<object, object> hashtable, System.Object item)
        {
            hashtable.Add(item, item);
        }

        public static void AddIfNotContains(IDictionary<object, object> hashtable, System.Object item)
        {
        ...
        public static void AddIfNotContains(List<object> hashtable, System.Object item)
        {
        ...
        public static void AddAll(IDictionary<object, object> hashtable, System.Collections.ICollection items)
        {
        ...
        public static void AddAllIfNotContains(IDictionary<object, object> hashtable, System.Collections.IList items)
        {
            System.Object item;
        ...
        public static void AddAllIfNotContains(IDictionary<object, object> hashtable, System.Collections.ICollection items)
        {
            System.Collections.IEnumerator iter = items.GetEnumerator();
            System.Object item;
            while (iter.MoveNext())
        ...
        public static System.String CollectionToString(System.Collections.ICollection c)
        {
            ...
            if (c != null)
            {
                ...
                bool isDictionary = (c is System.Collections.BitArray || c is System.Collections.IDictionary || (l.Count > 0 && l[0] is System.Collections.DictionaryEntry));
                ...
                if (isDictionary)
                {
                    if (c is System.Collections.IList)
                        isDictionary = false;
                }
                if (isDictionary)
                {
