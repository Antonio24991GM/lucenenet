...
namespace Lucene.Net.Store
{
    ...
    public class MMapDirectory : FSDirectory
    {
        ...
        public MMapDirectory(StorageFolder path, LockFactory lockFactory)
        ...
        /// <param name="path"> the path of the directory </param>
        /// <exception cref="System.IO.IOException"> if there is a low-level I/O error </exception>
        public MMapDirectory(StorageFolder path)
            : this(path, null)
        {
        }
        ...
        /// <exception cref="System.IO.IOException"> if there is a low-level I/O error </exception>
        public MMapDirectory(StorageFolder path, LockFactory lockFactory, int maxChunkSize)
